...
impl Statistics {
    pub fn new(total_transactions: usize, duration: u64) -> Self {
    ...
    pub fn print_stats(self) {
        ...
        let tps = success as u64 / inner.duration;
...
fn get_nth_response_time(response_time: &Vec<u128>, index: usize) -> u128 {
    let p = response_time
        .get(index)
